//===-- ABPFixupKinds.h - ABP Specific Fixup Entries ------------*- C++ -*-===//
//
...
#ifndef LLVM_ABP_FIXUP_KINDS_H
#define LLVM_ABP_FIXUP_KINDS_H
...
///       MCFixupKindInfo Infos[ABP::NumTargetFixupKinds]
///       in `ABPAsmBackend.cpp`.
enum Fixups {
  /// A 32-bit ABP fixup.
  ...
  ///       The nonmenclature is that ABP branch targets are
...
/// All branch targets in ABP are rightshifted by 1 to take advantage
